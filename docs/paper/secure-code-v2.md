...
**Dataset:** HuggingFace Hub: `https://huggingface.co/datasets/scthornton/securecode-v2`

**Source Code:** GitHub: `https://github.com/scthornton/securecode-v2`

**Validation Framework:** `https://github.com/scthornton/securecode-v2/blob/main/validate_contributing_compliance.py`
